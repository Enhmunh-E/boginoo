...
export const Navigation = () => {
    ...
    const { setDrop, drop, isHistory, setIsHistory } = useContext(Context);
        ...
        <div className='w100 flex justify-end items-center flex-wrap'>
            <div className='font-ubuntu fs-20 lh-23 bold c-primary ma-4'>ХЭРХЭН АЖИЛЛАДАГ ВЭ?</div>
            {
                !user ? (
                    ...
                    <div className="font-ubuntu fs-20 lh-23 bold pa-4 flex-row flex-center">
                        <div onClick={showHistory}>{user.email}</div>
